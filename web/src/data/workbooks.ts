...
export const WORKBOOKS: Workbook[] = [
  ...
  {
    id: 'wb-hbo-marketing',
    title: 'ORFHEUSS · Werkboek Marketing & Communicatie · HBO · 2026',
    level: 'hbo',
    domain: 'marketing',
...
Je leert niet 'het goede antwoord'. Je leert het verschil *herkennen*, *duiden* en *begrenzen*.`,
  ...
  {
    id: 'wb-hbo-sociaal',
    title: 'ORFHEUSS · Werkboek Sociaal Domein · HBO · 2026',
    level: 'hbo',
...
Gebruik dit werkboek ook als voorbereiding op casuïstiekbespreking.`,
  ...
  {
    id: 'wb-hbo-finance',
    title: 'ORFHEUSS · Werkboek Finance & Algoritmische Besluitvorming · HBO · 2026',
    level: 'hbo',
    domain: 'finance',
    roles: ['student', 'docent', 'begeleider'],
    introMd: `# ORFHEUSS
...
De vraag is niet of dat mag. De vraag is: *wanneer* mag dat, *onder welke voorwaarden*, en wie draagt de verantwoordelijkheid als het mis gaat?
...
Als één as faalt: blokkade of vertraging. De mens is de gate.`,
  ...
  {
    id: 'wb-hbo-digital',
    title: 'ORFHEUSS · Werkboek Digital & UX · HBO · 2026',
    level: 'hbo',
    domain: 'digital',
    roles: ['student', 'docent', 'begeleider'],
    introMd: `# ORFHEUSS
...
**Kwalificaties:** Kok (95390) · Ondernemer Horeca (93820) · Bakker (97640)`,
  ...
  // ── Docenten Marketing ───────────────────────────────────────────────────
  {
    ...
    title: 'ORFHEUSS · Docentenhandleiding Marketing & Communicatie · HBO · 2026',
    level: 'hbo',
    domain: 'marketing',
    roles: ['docent', 'begeleider'],
    introMd: `# ORFHEUSS
...
- Didactische aanwijzingen per case
- Veelgestelde vragen van studenten
- Differentiatie-aanwijzingen voor niveau en domein
- Suggesties voor casuïstiekbespreking en portfolio-opdrachten

## Basisprincipe voor de docent

ORFHEUSS vraagt studenten niet om 'het goede antwoord'. Het vraagt hen om het *verschil te herkennen* tussen wat een AI optimaliseert en wat verantwoord handelen vereist.
